let parseHTML =  require('../src/parser.js')

let assert = require('assert')

it('parse a single element', function () {
    let document = parseHTML.parseHTML('<div></div>');
  ...
  it('parse a single element with text content', function () {
    let document = parseHTML.parseHTML('<div>hello</div>');
  ...
  it('tag mismatch', function () {
    try {
      let document = parseHTML.parseHTML('<div></vid>');
    } catch (e) {
  ...
  it('test with <', function () {
    let document = parseHTML.parseHTML('<div>a < b</div>');
    let text = document.children[0].children[0];
  ...
  it('with property', function () {
    let document = parseHTML.parseHTML(`<div id=a class='cls' data="abc" ></div>`);
    let div = document.children[0];
  ...
  it('with property 3', function () {
    ...
    let document = parseHTML.parseHTML('<div id=a class="cls"data="abc"/>');
    let div = document.children[0];
  ...
  `;
    let document = parseHTML.parseHTML(`<script>${content}</script>`);
    let text = document.children[0].children[0];
  ...
  it('attribute with no value', function () {
    let document = parseHTML.parseHTML('<div class />');
    let div = document.children[0];
  ...
  it('attribute with no value2', function () {
    let document = parseHTML.parseHTML('<div class id data = />');
    let div = document.children[0];
  ...
  it('attribute with no value3', function () {
    let document = parseHTML.parseHTML('<div id = ></div>');
    let div = document.children[0];
  ...
  it('self closed single element', function () {
    let document = parseHTML.parseHTML('<div/>');
    let div = document.children[0];
  ...
  it('empty tagname element', function () {
    let document = parseHTML.parseHTML('</>');
    let div = document.children[0];
